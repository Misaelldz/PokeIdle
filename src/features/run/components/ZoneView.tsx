            ...
            return (
              ...
              >
                ...
                <div className="absolute hidden group-hover:block bottom-full left-1/2 -translate-x-1/2 mb-1 bg-surface-dark border border-border p-1 text-[0.5rem] font-display text-white z-10 whitespace-nowrap text-center shadow-pixel">
                  ...
                  <div className="text-[0.4rem] text-muted">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between group">
              ...
              <button
                ...
                className={`px-3 py-1 font-display text-[0.55rem] border-2 transition-colors ${run.autoCapture ? "bg-success/20 text-success border-success" : "bg-surface-dark text-muted border-border hover:border-muted"}`}
              >
            ...
            <div className="flex items-center justify-between group">
              ...
              <button
                ...
                className={`px-3 py-1 font-display text-[0.55rem] border-2 transition-colors ${run.isManualBattle ? "bg-brand/20 text-brand border-brand" : "bg-surface-dark text-muted border-border hover:border-muted"}`}
              >
